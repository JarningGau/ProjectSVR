...
If you want to use the [`RunCNMF`](https://jarninggau.github.io/ProjectSVR/reference/RunCNMF.html) function for feature selection. The python package [`cnmf`](https://github.com/dylkot/cNMF) should installed via `reticulate`.
